...
public class ItemController {
    ...
    @GetMapping(FILTERED)
    public Page<ItemDTO> allItemsFiltered(@ModelAttribute("filter") ItemFilterRequestDto filter, Pageable pageable) {
        return itemService.allItemsFiltered(filter, pageable);
    }
